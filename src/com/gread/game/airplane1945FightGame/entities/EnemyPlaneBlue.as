package com.gread.game.airplane1945FightGame.entities
{
	...
	public class EnemyPlaneBlue extends FlxSprite implements IEnemyPlane
	{	
		...
		[Embed(source="../assets/BlueEnemyPlane.png")]
		...
		public function EnemyPlaneBlue(xPos:Number=0, yPos:Number=0)
		{
			//super(x, y, planeImg);
			x = xPos;
			y = yPos;
