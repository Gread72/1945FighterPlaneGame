package com.gread.game.airplane1945FightGame.entities
{
	...
	public class SmallExplosionEntity extends FlxSprite
	{
		public static var WIDTH:Number = 32;
		public static var HEIGHT:Number = 32;
		
		[Embed(source="../assets/explosionImgSmall.png")]
		private var explodeImg:Class;
		
		public function SmallExplosionEntity(xPos:Number=0, yPos:Number=0){
			//super(x, y, planeImg);
			x = xPos;
			y = yPos;
